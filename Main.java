...
public class Main {
	...
	public static ArrayList<String> sav = new ArrayList<String>();
	...
	sav=implementInterface(new Class1());
	Class1 test = new Class1();
	test.toString();
	test.popfields(sav);
}

public static ArrayList<String> implementInterface(Class1 no1) {
	
	sav = no1.rtnarry();
	for (int i=0;i<sav.size();i++) {
		System.out.println("idx: " +i +", value: " +sav.get(i));
	}
	return sav;
